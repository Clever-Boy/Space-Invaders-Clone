...
std::vector<SpaceshipData> initializeSpaceshipData()
{
	...
	data[Spaceship::Enemy1].directions.push_back(Direction(90.f, 160.f));
	data[Spaceship::Enemy1].directions.push_back(Direction(0.f, 30.f));
	data[Spaceship::Enemy1].directions.push_back(Direction(-90.f, 160.f * 2));
	data[Spaceship::Enemy1].directions.push_back(Direction(0.f, 30.f));
	data[Spaceship::Enemy1].directions.push_back(Direction(+90.f, 160.f));
	...
	data[Spaceship::Enemy2].directions.push_back(Direction(90.f, 160.f));
	data[Spaceship::Enemy2].directions.push_back(Direction(0.f, 30.f));
	data[Spaceship::Enemy2].directions.push_back(Direction(-90.f, 160.f * 2));
	data[Spaceship::Enemy2].directions.push_back(Direction(0.f, 30.f));
	data[Spaceship::Enemy2].directions.push_back(Direction(+90.f, 160.f));
	...
	data[Spaceship::Enemy3].directions.push_back(Direction(90.f, 160.f));
	data[Spaceship::Enemy3].directions.push_back(Direction(0.f, 30.f));
	data[Spaceship::Enemy3].directions.push_back(Direction(-90.f, 160.f * 2));
	data[Spaceship::Enemy3].directions.push_back(Direction(0.f, 30.f));
	data[Spaceship::Enemy3].directions.push_back(Direction(+90.f, 160.f));
